...
public class Officier extends Militaire{

	public Officier(String nom, String prenom, Secu secu, Gouvernement g, Armée armée, int regiment) {
		super(nom, prenom, secu, g, armée, regiment);
	}
	
	public void donnerUnOrdre(){
		System.out.println("Nettoyez les toilettes");
	}
